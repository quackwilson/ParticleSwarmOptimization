    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 2001; i++)
            {
                ...
                using (var writer = new StreamWriter("./P8.csv", append))
        ...
        static double EasomFunction(double x0, double x1)
        {
            double a = Math.Cos(x0),
                b = Math.Cos(x1),
                c = x0 - Math.PI,
                d = c * c,
                e = x1 - Math.PI,
    ...
    class Particle
    {
        public Particle(Random num, int variableNumber, int particleNumber)
        {
            ...
            for (int i = 0; i < variableNumber; i++)
            {
                ...
                {
                    double ran = NextDouble(num, -100.00, 100.00);
                    particles[i, j] = ran;
                    Particles = particles;
                }
            }
